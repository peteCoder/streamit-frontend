...
const Search = ({onClick, onBlur, extraStyle}) => {
  return (
    <svg onClick={onClick} onBlur={onBlur} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={extraStyle}>
