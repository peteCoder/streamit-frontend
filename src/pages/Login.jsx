...
const LogIn = () => {
  ...
  const {logIn, loading, error: loginError } = useAuthContext()
          ...
          <div className="pt-[80px] min-h-screen flex justify-center items-center">
            ...
            <form method='POST' onSubmit={handleSubmit(onSubmit)} className="w-full sm:w-[430px] h-fit bg-black
              sm:bg-[rgba(0,0,0,.75)] bg-transparent rounded-md flex flex-col px-[20px] sm:px-[40px] md:px-[60px] py-3">
                ...
                <div>
                    <h1 className='text-white mb-7 text-[25px] sm:text-[30px] md:text-[32px] font-[500]'>Log in</h1>
                    {loginError && (
                      <div className="validation text-[#e87c03] text-[12px] mb-1 py-[6px] px-[3px]">{loginError}</div>
                    )}
                    ...
                    {errors.email && (
                      <div id="validation" className="validation text-[#e87c03] text-[12px] mb-1 py-[6px] px-[3px]">
                        Please enter a valid email.
                      </div>
                    )}
                    
                  
                    <div className='relative w-full h-[50px] text-[#8c8c8c] mt-3'>
